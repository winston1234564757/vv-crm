-- Migration: Remove ambiguous overload and keep a single clean RPC for withdraw_owner_share

-- Drop all previous overloads to eliminate candidate ambiguity
DROP FUNCTION IF EXISTS public.withdraw_owner_share(NUMERIC, TEXT, UUID, TEXT, UUID);
DROP FUNCTION IF EXISTS public.withdraw_owner_share(TEXT, UUID, NUMERIC, TEXT, UUID);
DROP FUNCTION IF EXISTS public.withdraw_owner_share(TEXT, UUID, INT, TEXT, UUID);
